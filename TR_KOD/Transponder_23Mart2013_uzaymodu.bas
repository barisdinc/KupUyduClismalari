...
Dim  TR_MD  As Byte
TR_MD = TR_OFF  'buradan ilk acilistaki durumumuzu set ediyoruz.... labda isek ilk acilis on olacak.. cunku i2c kanalindan veri gonderecek kimse yok
...
Dim DakikaOld As Byte
Dim BekleGun  As Byte
...
'               LastData = SSP1BUF          ' veriyi oku 
               ...
               GoSub ZamanSifirla                         '******** I2C Datasi geldiginde zaman sayacini sifirliyoruz
               Inc I2C_DataCount
...
'her resetten sonra zaman sayaclarini sifirla
Dakika = 0
Saniye = 0
DakikaOld = 0
BekleGun = 14  '14 gun boyunca I2C datasi gelmez ise kendimizi aciyoruz...
...
If Gun >= BekleGun Then
   If Gun < 21 Then
      TR_MD = TR_ON
      If Dakika  > 6 Then 
        TR_MD = TR_OFF
      Else If Dakika > 12 Then
        TR_MD = TR_ON
      Else If Dakika > 18 Then
        TR_MD = TR_OFF
      Else If Dakika > 24 Then
        TR_MD = TR_ON
      Else If Dakika > 30 Then
        TR_MD = TR_OFF
      Else If Dakika > 36 Then
        TR_MD = TR_ON
      Else If Dakika > 42 Then
        TR_MD = TR_OFF
      Else If Dakika > 48 Then
        TR_MD = TR_ON
      Else If Dakika > 54 Then
        TR_MD = TR_OFF
      EndIf
   Else
      TR_MD = TR_OFF
...
For say = 1 To 2  'BUNU 20 yapmayi unutma .. gurultu yapiyor
...
ZamanSifirla:
    ...
    Gun    = 0
    Hafta  = 0
    'TR_MD = TR_OFF  'Her Ihtimale Karsi Transponder'i kapatiyoruz    
    BekleGun = 14   '14 gun boyunca I2C datasi gelmez ise kendimizi aciyoruz... I2C geldi ise yeniden 14 gun sayiyoruz
Return
