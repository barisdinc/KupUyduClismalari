...
I2C_Data = 42
SW_Data = 43
variable SW_Data#0=43,SW_Data#1=44,SW_Data#2=45,SW_Data#3=46
variable SW_Data#4=47,SW_Data#5=48,SW_Data#6=49,SW_Data#7=50
variable SW_Data#8=51,SW_Data#9=52
_I = 53
Sayi = 54
_High__Context_Store = 55
variable _High__Context_Store#0=55,_High__Context_Store#1=56,_High__Context_Store#2=57
...
proton#main#start
        movlb 0
F2_SOF equ $ ; TRANSPONDER_I2C.PRP
F2_EOF equ $ ; TRANSPONDER_I2C.PRP
F1_SOF equ $ ; TRANSPONDER_I2C.BAS
F1_000054 equ $ ; IN [TRANSPONDER_I2C.BAS] ALL_DIGITAL   = TRUE
        clrf CM1CON0,0
        clrf CM2CON0,0
        clrf ANSEL,0
        clrf ANSELH,0
        movlw 15
        movwf ADCON1,0
F1_000060 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISA.0 = 1
        bsf TRISA,0,0
F1_000061 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISA.1 = 1
        bsf TRISA,1,0
F1_000062 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISA.2 = 1
        bsf TRISA,2,0
F1_000063 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISA.3 = 1
        bsf TRISA,3,0
F1_000064 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISA.4 = 0
        bcf TRISA,4,0
F1_000065 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISA.5 = 0
        bcf TRISA,5,0
F1_000067 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISB.0 = 1
        bsf TRISB,0,0
F1_000068 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISB.1 = 1
        bsf TRISB,1,0
F1_000069 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISB.2 = 1
        bsf TRISB,2,0
F1_000070 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISB.3 = 0
        bcf TRISB,3,0
F1_000071 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISB.4 = 0
        bcf TRISB,4,0
F1_000072 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISB.5 = 0
        bcf TRISB,5,0
F1_000073 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISB.6 = 0
        bcf TRISB,6,0
F1_000074 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISB.7 = 0
        bcf TRISB,7,0
F1_000076 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISC.0 = 0
        bcf TRISC,0,0
F1_000077 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISC.1 = 0
        bcf TRISC,1,0
F1_000078 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISC.2 = 0
        bcf TRISC,2,0
F1_000079 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISC.3 = 1
        bsf TRISC,3,0
F1_000080 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISC.4 = 1
        bsf TRISC,4,0
F1_000081 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISC.5 = 1
        bsf TRISC,5,0
F1_000082 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISC.6 = 1
        bsf TRISC,6,0
F1_000083 equ $ ; IN [TRANSPONDER_I2C.BAS] TRISC.7 = 0
        bcf TRISC,7,0
F1_000122 equ $ ; IN [TRANSPONDER_I2C.BAS] LOW PLLPSRF
        bcf TRISB,6,0
        bcf LATB,6,0
F1_000123 equ $ ; IN [TRANSPONDER_I2C.BAS] LOW PLLPSIF
        bcf TRISB,7,0
        bcf LATB,7,0
F1_000124 equ $ ; IN [TRANSPONDER_I2C.BAS] LOW  TPS2421EN
        bcf TRISA,4,0
        bcf LATA,4,0
F1_000125 equ $ ; IN [TRANSPONDER_I2C.BAS] HIGH LD29300ENABLE
        bcf TRISC,0,0
        bsf LATC,0,0
F1_000126 equ $ ; IN [TRANSPONDER_I2C.BAS] LOW PLLLE
        bcf TRISB,5,0
        bcf LATB,5,0
F1_000127 equ $ ; IN [TRANSPONDER_I2C.BAS] HIGH PLLPSRF
        bcf TRISB,6,0
        bsf LATB,6,0
F1_000128 equ $ ; IN [TRANSPONDER_I2C.BAS] HIGH PLLPSIF
        bcf TRISB,7,0
        bsf LATB,7,0
F1_000133 equ $ ; IN [TRANSPONDER_I2C.BAS] DUTYCYCLE = 0
        clrf DutyCycle,0
F1_000138 equ $ ; IN [TRANSPONDER_I2C.BAS] SLAVE_ADDRESS = $33
        movlw 51
        movwf Slave_Address,0
F1_000139 equ $ ; IN [TRANSPONDER_I2C.BAS] SSPADD = SLAVE_ADDRESS
        movff Slave_Address,SSPADD
F1_000140 equ $ ; IN [TRANSPONDER_I2C.BAS] SSPCON2 = 0
        clrf SSPCON2,0
F1_000141 equ $ ; IN [TRANSPONDER_I2C.BAS] SSPCON1 = $36
        movlw 54
        movwf SSPCON1,0
F1_000159 equ $ ; IN [TRANSPONDER_I2C.BAS] SMP = 1
        bsf SSPSTAT,7,0
F1_000170 equ $ ; IN [TRANSPONDER_I2C.BAS] PEIE = 1
        bsf INTCON,6,0
F1_000171 equ $ ; IN [TRANSPONDER_I2C.BAS] GIE = 1
        bsf INTCON,7,0
F1_000172 equ $ ; IN [TRANSPONDER_I2C.BAS] SSP1IF = 0
        bcf PIR1,3,0
F1_000173 equ $ ; IN [TRANSPONDER_I2C.BAS] SSP1IE = 1
        bsf PIE1,3,0
F1_000180 equ $ ; IN [TRANSPONDER_I2C.BAS] I = 0
        clrf _I,0
F1_000189 equ $ ; IN [TRANSPONDER_I2C.BAS] GOTO STARTHERE
        f@jump StartHere
I2C_Interrupt
F1_000192 equ $ ; IN [TRANSPONDER_I2C.BAS] CONTEXT SAVE
        movlb 0
        movff FSR0H,_High__Context_Store#0
        movff FSR0L,_High__Context_Store#1
        movff SP#P9,_High__Context_Store#2
F1_000193 equ $ ; IN [TRANSPONDER_I2C.BAS] HIGH AD8317FINAL
        bcf TRISC,7,0
        bsf LATC,7,0
F1_000194 equ $ ; IN [TRANSPONDER_I2C.BAS] IF SSPIF = 1 THEN
        btfss PIR1,3,0
        go@to BC@LL3
F1_000195 equ $ ; IN [TRANSPONDER_I2C.BAS] SSPIF = 0
        bcf PIR1,3,0
F1_000196 equ $ ; IN [TRANSPONDER_I2C.BAS] IF BF = 1 THEN
        btfss SSPSTAT,0,0
        go@to BC@LL5
F1_000197 equ $ ; IN [TRANSPONDER_I2C.BAS] I2C_DATA = SW_DATA[I]
        lfsr 0,SW_Data
        movf _I,W,0
        movf PLUSW0,W,0
        movwf I2C_Data,0
F1_000198 equ $ ; IN [TRANSPONDER_I2C.BAS] SSPBUF = I2C_DATA
        movff I2C_Data,SSPBUF
F1_000199 equ $ ; IN [TRANSPONDER_I2C.BAS] CKP = 1
        bsf SSPCON1,4,0
F1_000200 equ $ ; IN [TRANSPONDER_I2C.BAS] INC I
        incf _I,F,0
F1_000201 equ $ ; IN [TRANSPONDER_I2C.BAS] IF I = 10 THEN CLEAR I
        movlw 10
        cpfseq _I,0
        f@jump BC@LL7
        clrf _I,0
BC@LL7
F1_000202 equ $ ; IN [TRANSPONDER_I2C.BAS] ENDIF
BC@LL5
F1_000206 equ $ ; IN [TRANSPONDER_I2C.BAS] ENDIF
BC@LL3
F1_000208 equ $ ; IN [TRANSPONDER_I2C.BAS] GOTO END_INTERRUPT
        f@jump End_Interrupt
End_Interrupt
F1_000212 equ $ ; IN [TRANSPONDER_I2C.BAS] IF R_W = 0 AND SSPOV = 1 THEN SSPOV = 0
        movlw 1
        btfsc SSPSTAT,2,0
        movlw 0
        movwf SP#P9,0
        ...
        bcf SSPCON1,6,0
BC@LL9
F1_000213 equ $ ; IN [TRANSPONDER_I2C.BAS] IF R_W = 1 AND WCOL = 1 THEN WCOL = 0
        movlw 0
        btfsc SSPSTAT,2,0
        movlw 1
        movwf SP#P9,0
        ...
        bcf SSPCON1,7,0
BC@LL11
F1_000217 equ $ ; IN [TRANSPONDER_I2C.BAS] CONTEXT RESTORE
        movff _High__Context_Store#0,FSR0H
        movff _High__Context_Store#1,FSR0L
        movff _High__Context_Store#2,SP#P9
        retfie 1
StartHere
F1_000223 equ $ ; IN [TRANSPONDER_I2C.BAS] HPWM 1,10,2000
        movlw 10
        movwf GEN,0
        movlw 7
        movwf PP1H,0
        ...
        f@call __HPWM_
Main
F1_000227 equ $ ; IN [TRANSPONDER_I2C.BAS] SW_DATA[0] = 34
        movlw 34
        movwf SW_Data#0,0
F1_000228 equ $ ; IN [TRANSPONDER_I2C.BAS] SW_DATA[1] = 92
        movlw 92
        movwf SW_Data#1,0
F1_000229 equ $ ; IN [TRANSPONDER_I2C.BAS] SW_DATA[2] = 76
        movlw 76
        movwf SW_Data#2,0
F1_000238 equ $ ; IN [TRANSPONDER_I2C.BAS] DATAOUT =  %000000000000000100110000010000
        clrf DataOutHHH,0
        clrf DataOutHH,0
        movwf DataOutH,0
        movlw 16
        movwf DataOut,0
F1_000239 equ $ ; IN [TRANSPONDER_I2C.BAS] GOSUB PLLGONDER
        f@call Pllgonder
F1_000242 equ $ ; IN [TRANSPONDER_I2C.BAS] DATAOUT =  %000000001101100000011110101101
        clrf DataOutHHH,0
        movlw 54
        movwf DataOutHH,0
        movlw 7
        ...
        movlw 173
        movwf DataOut,0
F1_000243 equ $ ; IN [TRANSPONDER_I2C.BAS] GOSUB     PLLGONDER
        f@call Pllgonder
F1_000248 equ $ ; IN [TRANSPONDER_I2C.BAS] DATAOUT =  %000000010000000010100000010000
        clrf DataOutHHH,0
        movlw 64
        movwf DataOutHH,0
        movlw 40
        ...
        movlw 16
        movwf DataOut,0
F1_000249 equ $ ; IN [TRANSPONDER_I2C.BAS] GOSUB PLLGONDER
        f@call Pllgonder
F1_000252 equ $ ; IN [TRANSPONDER_I2C.BAS] DATAOUT =  %000000011011111101010011011000
        clrf DataOutHHH,0
        movlw 111
        movwf DataOutHH,0
        movlw 212
        ...
        movlw 216
        movwf DataOut,0
F1_000253 equ $ ; IN [TRANSPONDER_I2C.BAS] GOSUB     PLLGONDER
        f@call Pllgonder
F1_000257 equ $ ; IN [TRANSPONDER_I2C.BAS] DELAYMS 1000
        movlw 3
        movwf PP1H,0
        movlw 232
        f@call __DELAY_MS_W_
F1_000259 equ $ ; IN [TRANSPONDER_I2C.BAS] FOR SAYI = 1 TO 5
        movlw 1
        movwf Sayi,0
FR@LB12
        movlw 6
        cpfslt Sayi,0
        f@jump NX@LB13
F1_000260 equ $ ; IN [TRANSPONDER_I2C.BAS] DELAYMS 1000
        movlw 3
        movwf PP1H,0
        movlw 232
        f@call __DELAY_MS_W_
CT@LB14
F1_000261 equ $ ; IN [TRANSPONDER_I2C.BAS] NEXT SAYI
        incf Sayi,F,0
        btfss STATUS,0,0
        go@to FR@LB12
NX@LB13
F1_000262 equ $ ; IN [TRANSPONDER_I2C.BAS] TOGGLE TPS3823WDI
        btg PORTC,1,0
        bcf TRISC,1,0
F1_000264 equ $ ; IN [TRANSPONDER_I2C.BAS] GOTO MAIN
        f@jump Main
Pllgonder
F1_000277 equ $ ; IN [TRANSPONDER_I2C.BAS] FOR SAYAC = 1 TO 23
        movlw 1
        movwf sayac,0
FR@LB15
        movlw 24
        cpfslt sayac,0
        f@jump NX@LB16
F1_000278 equ $ ; IN [TRANSPONDER_I2C.BAS] LOW PLLDATA
        bcf TRISB,4,0
        bcf LATB,4,0
F1_000279 equ $ ; IN [TRANSPONDER_I2C.BAS] IF (DATAOUT & 1) = 1 THEN HIGH PLLDATA
        movlw 1
        andwf DataOut,W,0
        clrf PBP#VAR0HHH,0
        clrf PBP#VAR0HH,0
        ...
        bsf LATB,4,0
BC@LL19
F1_000280 equ $ ; IN [TRANSPONDER_I2C.BAS] DATAOUT = DATAOUT >> 1
        bcf STATUS,0,0
        rrcf DataOutHHH,F,0
        rrcf DataOutHH,F,0
        rrcf DataOutH,F,0
        rrcf DataOut,F,0
F1_000281 equ $ ; IN [TRANSPONDER_I2C.BAS] DELAYUS 10
        movlw 3
        decfsz WREG,F,0
        bra $ - 2
        nop
        nop
F1_000282 equ $ ; IN [TRANSPONDER_I2C.BAS] HIGH PLLCLK
        bcf TRISB,3,0
        bsf LATB,3,0
F1_000283 equ $ ; IN [TRANSPONDER_I2C.BAS] DELAYUS 10
        movlw 3
        decfsz WREG,F,0
        bra $ - 2
        nop
        nop
F1_000284 equ $ ; IN [TRANSPONDER_I2C.BAS] LOW PLLCLK
        bcf TRISB,3,0
        bcf LATB,3,0
F1_000285 equ $ ; IN [TRANSPONDER_I2C.BAS] DELAYUS 10
        movlw 3
        decfsz WREG,F,0
        bra $ - 2
        nop
        nop
CT@LB17
F1_000286 equ $ ; IN [TRANSPONDER_I2C.BAS] NEXT SAYAC
        incf sayac,F,0
        btfss STATUS,0,0
        go@to FR@LB15
NX@LB16
F1_000288 equ $ ; IN [TRANSPONDER_I2C.BAS] HIGH PLLLE
        bcf TRISB,5,0
        bsf LATB,5,0
F1_000289 equ $ ; IN [TRANSPONDER_I2C.BAS] DELAYUS 10
        movlw 3
        decfsz WREG,F,0
        bra $ - 2
        nop
        nop
F1_000290 equ $ ; IN [TRANSPONDER_I2C.BAS] LOW PLLLE
        bcf TRISB,5,0
        bcf LATB,5,0
F1_000291 equ $ ; IN [TRANSPONDER_I2C.BAS] DELAYUS 10
        movlw 3
        decfsz WREG,F,0
        bra $ - 2
        nop
        nop
F1_000293 equ $ ; IN [TRANSPONDER_I2C.BAS] RETURN
        return 0
F1_EOF equ $ ; TRANSPONDER_I2C.BAS
PB@LB20
        bra PB@LB20
__EOF
config FOSC = XT
